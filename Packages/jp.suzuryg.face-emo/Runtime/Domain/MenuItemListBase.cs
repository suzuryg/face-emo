...
namespace Suzuryg.FaceEmo.Domain
{
    ...
    public abstract class MenuItemListBase : IMenuItemList
    {
        ...
        public void Insert(Mode mode, string id, int? index = null)
        {
            ...
            {
                throw new FaceEmoException("The source and the destination are same.");
            }
        ...
        private void Insert(string id, int? index = null)
        {
            if (IsFull)
            {
                throw new FaceEmoException("The number of menu items exceeds the limit.");
            }

            if (_order.Any(x => x == id))
            {
                throw new FaceEmoException("The inserted menu item is already exists in this list.");
            }
        ...
        public void Remove(string id)
        {
            ...
            {
                throw new FaceEmoException("This MenuItemList does not contain the specified MenuItem.");
            }
        }
